...
class PickupsControllerTest < ActionController::TestCase
  ...
  test "should create pickup" do
    assert_difference('Pickup.count') do
      post :create, pickup: { class_id: @pickup.class_id, comment: @pickup.comment, name: @pickup.name, role_type_id: @pickup.role_type_id }
    end
  ...
  test "should update pickup" do
    patch :update, id: @pickup, pickup: { class_id: @pickup.class_id, comment: @pickup.comment, name: @pickup.name, role_type_id: @pickup.role_type_id }
    assert_redirected_to pickup_path(assigns(:pickup))
  end
