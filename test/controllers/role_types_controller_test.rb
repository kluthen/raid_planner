...
class RoleTypesControllerTest < ActionController::TestCase
  ...
  test "should create role_type" do
    assert_difference('RoleType.count') do
      post :create, role_type: { description: @role_type.description, name: @role_type.name, role_type_id: @role_type.role_type_id }
    end
  ...
  test "should update role_type" do
    patch :update, id: @role_type, role_type: { description: @role_type.description, name: @role_type.name, role_type_id: @role_type.role_type_id }
    assert_redirected_to role_type_path(assigns(:role_type))
  end
