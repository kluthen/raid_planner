class PickupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pickup.save
        format.html { redirect_to @pickup.participating.role.event, notice: 'Pickup was successfully created.' }
  ...
  private
    ...
    def pickup_params
      params.require(:pickup).permit(:role_type_id, :classe, :name, :comment, participating_attributes: [:id, :comment, :role_id, :pickup_id])
    end
end
